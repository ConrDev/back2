...
<html lang="en">
  ...
  <body style="background-color: lightgray;">
    <div class="modal-content col-5 mx-auto p-5">
        <h1 for="" class="text-center">Lid Bewerken</h1><br>

        <form method="post" action="../backend/controllers/lid_bewerk_verwerk.php">
            
            <input type="hidden" name="id" value="<?=$id; ?>">

            <div class="form-check form-check-inline">
                <label>
                    <input type="radio" class="form-check-input" name="gender" id="gender_m" value="M" <?php if ($row['gender'] == 'M') echo "checked"; ?>>
                    <br>
                    <i class="fas fa-male    "></i>
                </label>
                
                <label>
                    <input type="radio" class="form-check-input" name="gender" id="gender_f" value="F" <?php if ($row['gender'] == 'F') echo "checked"; ?>>
                    <br>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="member_since" id="member_since" value="<?=$row['member_since']; ?>" required>
            </div>
